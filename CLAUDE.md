...
│  - Component: src/paged-editor/OffscreenEditorHost.tsx         │
└──────────────────────────────────────────────────────────────┘
...
│  - Entry: src/layout-painter/paintPage.ts                   │
└──────────────────────────────────────────────────────────────┘
```
...
DOCX file
  ...
  → OffscreenEditorHost renders off-screen
...
| How pages are composed               | `layout-painter/paintPage.ts`                           |
