...
| 5. Lay out into pages                    | `./layout-engine`                                 | `layOutPages(blocks, measures, options) → Layout`                                                |
| 6. Bridge clicks/measurements            | `./layout-bridge`                                 | `buildBoxTree`, `mouseToPosition`, `rectsForSelection`, `pointerHitResolve`, footnote layout, text measurement |
| 7. Paint the pages                       | `./layout-painter`                                | `paintPage(page, context, options) → HTMLElement`, `LayoutPainter` class                           |
