/**
 * Shared types and primitive helpers used across buildBoxTree sub-modules.
 */
...
export type BuildBoxTreeOptions = {
  ...
  /**
   * Document-wide `w:defaultTabMark` (§17.6.13) in twips. Stamped onto each
  ...
  /**
   * @internal Allocated by buildBoxTree() and threaded through table /
