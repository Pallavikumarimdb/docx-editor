 ...
 * to do anything** — both adapters (`@docx-editor.dev/react`,
 * `@docx-editor.dev/vue`) auto-mount this inside the `DocxEditor`
 ...
 * @example
 * ```ts
 * import { createSuggestionModePlugin } from '@docx-editor.dev/core/prosemirror/plugins';
 *
