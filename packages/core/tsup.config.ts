...
export default defineConfig([
  {
    entry: {
      ...
      'pagination-model/index': 'src/pagination-model/index.ts',
      'pagination-model/types': 'src/pagination-model/types.ts',
      'painter-model/index': 'src/painter-model/index.ts',
      'painter-model/paintPage': 'src/painter-model/paintPage.ts',
      'flow-model/index': 'src/flow-model/index.ts',
      'flow-model/resolveDomPosition': 'src/flow-model/resolveDomPosition.ts',
      'flow-model/metrics/index': 'src/flow-model/metrics/index.ts',
      'flow-model/tableInsertHover': 'src/flow-model/tableInsertHover.ts',
      'flow-model/buildBoxTree': 'src/flow-model/buildBoxTree.ts',
