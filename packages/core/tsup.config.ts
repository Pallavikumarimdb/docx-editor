...
export default defineConfig([
  {
    entry: {
      ...
      'layout-painter/paintPage': 'src/layout-painter/paintPage.ts',
      'layout-bridge/index': 'src/layout-bridge/index.ts',
      'layout-bridge/resolveDomPosition': 'src/layout-bridge/resolveDomPosition.ts',
      ...
      'layout-bridge/buildBoxTree': 'src/layout-bridge/buildBoxTree.ts',
