...
function tableCellAttrsToFormatting(attrs: TableCellAttrs): TableCellFormatting | undefined {
  ...
  if (extendedAttrs.borders) {
    ...
    if (extendedAttrs.borders.top) {
      borders.top = { style: borderKind, size: borderSize, color: borderColor };
    }
    if (extendedAttrs.borders.bottom) {
      borders.bottom = { style: borderKind, size: borderSize, color: borderColor };
    }
    if (extendedAttrs.borders.left) {
      borders.left = { style: borderKind, size: borderSize, color: borderColor };
    }
    if (extendedAttrs.borders.right) {
      borders.right = { style: borderKind, size: borderSize, color: borderColor };
    }
  }
