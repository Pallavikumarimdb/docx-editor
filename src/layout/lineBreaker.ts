...
import type { Paragraph, Run, TextFormatting, Theme, TabMark } from '../types/document';
import { measureTextWidth, getLineHeight } from '../utils/textMeasure';
import { twipsToPixels } from '../utils/units';
import { getNextTabMark, DEFAULT_TAB_INTERVAL_TWIPS } from '../docx/tabParser';
...
function calculateTabWidthForPosition(
  ...
  const tabInfo = getNextTabMark(positionTwips, tabMarks, maxWidthTwips);
