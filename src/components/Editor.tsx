...
export const Editor = React.forwardRef<EditorRef, EditorProps>(function Editor(
  ...
  const renderSinglePage = useCallback(
    ...
    [zoom, showPageShadows, paintPageContent, paintPage]
  );
  ...
  }, [enablePagination, pageLayout, renderAllContent, paintPage, sectionProps, zoom, showPageShadows, showPageNumbers, pageGap]);
