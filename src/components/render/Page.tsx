 ...
 */
function mapBorderKindToCss(
  borderKind: string | undefined
...
function PageBorders({ borders, theme, zoom }: PageBordersProps): React.ReactElement | null {
  ...
  if (borders.top) {
    ...
    style.borderTopStyle = mapBorderKindToCss(borders.top.style);
  ...
  if (borders.bottom) {
    ...
    style.borderBottomStyle = mapBorderKindToCss(borders.bottom.style);
  ...
  if (borders.left) {
    ...
    style.borderLeftStyle = mapBorderKindToCss(borders.left.style);
  ...
  if (borders.right) {
    ...
    style.borderRightStyle = mapBorderKindToCss(borders.right.style);
