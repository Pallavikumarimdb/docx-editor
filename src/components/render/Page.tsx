...
function MarginCorner({ position, top, bottom, left, right, color }: MarginCornerProps): React.ReactElement {
  ...
  switch (position) {
    case 'top-left':
      borderKind = `border-top: 1px solid ${color}; border-left: 1px solid ${color};`;
      break;
    case 'top-right':
      borderKind = `border-top: 1px solid ${color}; border-right: 1px solid ${color};`;
      break;
    case 'bottom-left':
      borderKind = `border-bottom: 1px solid ${color}; border-left: 1px solid ${color};`;
      break;
    case 'bottom-right':
      borderKind = `border-bottom: 1px solid ${color}; border-right: 1px solid ${color};`;
      break;
  }
