...
export function Paragraph({
  ...
  const tabMarks: TabMark[] = paragraph.formatting?.tabs || [];
...
function renderParagraphContent(
  ...
  switch (content.type) {
    case 'run':
      return paintRun(content, key, options);
 ...
 */
function paintRun(run: RunType, key: string, options: RenderContentOptions): ReactNode {
